export const doctorKeys = {
  ...
  reportDraft: (studyId: string) => ["doctor", "report", "draft", studyId] as const,
  reportFull: (studyId: string) => ["doctor", "report", "full", studyId] as const,
  ...
  performance: (period?: string) => ["doctor", "performance", period ?? "month"] as const,
  watchlist: ["doctor", "watchlist"] as const,
  followups: (filter?: string) => ["doctor", "followups", filter ?? "all"] as const,
